...
import pl.edu.agh.school.guice.LoggerModule;
...
public class SchoolDemo {
    ...
    public SchoolDemo() {
        final Injector injector = Guice.createInjector(new SchoolModule(), new LoggerModule());
    ...
    public void initClass() throws ParseException {
        if (school.findClass("1A", "humane").isEmpty()) {
            SchoolClass schoolClass = new SchoolClass("1A", "humane", logger);
